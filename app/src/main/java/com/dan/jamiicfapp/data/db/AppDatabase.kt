...
@Database(
    entities = [User::class, DisabledCaseDetails::class, JcaEvent::class, Comment::class, RecordedCase::class, DonationList::class],
    version = 1
)
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun getDonationList(): DonationListDao
