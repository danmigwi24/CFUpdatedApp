...
import kotlinx.android.synthetic.main.activity_mpesa2.*
...
class Mpesa2Activity : AppCompatActivity(), KodeinAware {
    ...
    companion object {
        private val TAG = Mpesa2Activity::class.java.simpleName
    }
